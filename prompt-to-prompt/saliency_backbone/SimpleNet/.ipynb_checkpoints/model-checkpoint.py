...
sys.path.append('/sinergia/bahar/visual-int/visintproject/prompt-to-prompt/saliency_backbone/')
sys.path.append('/sinergia/bahar/visual-int/visintproject/prompt-to-prompt/saliency_backbone/PNAS/')
sys.path.append('/sinergia/bahar/visual-int/visintproject/prompt-to-prompt/saliency_backbone/SimpleNet/')
